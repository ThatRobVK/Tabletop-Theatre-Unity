...
namespace TT.UI.MapEditor
{
    ...
    public class NewScatterAreaButton : MonoBehaviour
    {
        ...
        private void HandleButtonClick()
        {
            ...
            StateController.Current.ChangeState(StateType.NatureObjectPlacement);
            (StateController.CurrentState as WorldObjectPlacementState)?.Initialise(item);
        }
